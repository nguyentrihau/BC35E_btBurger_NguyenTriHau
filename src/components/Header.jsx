                ...
                <nav className="navbar navbar-expand-md bg-primary navbar-dark">
                    ...
                    <div className="collapse navbar-collapse" id="collapsibleNavbar">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                <NavLink className={({isActive})=> isActive?'nav-link bg-success mx-1 text-white':'nav-link bg-dark mx-1'} to="/burger" style={({isActive})=>isActive?{color:'red',borderRadius:'5px'}:{borderRadius:'5px'}}>Burger</NavLink>
                            </li>   
                            <li className="nav-item">
